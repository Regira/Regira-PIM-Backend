...
public class OrderPrepper(PimDbContext dbContext) : EntityPrepperBase<Order>
{
...
{
    public static void PrepareOrderLines(this Order item, PimDbContext dbContext, Order? original)
    {
