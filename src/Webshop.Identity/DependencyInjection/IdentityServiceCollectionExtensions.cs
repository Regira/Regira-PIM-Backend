...
public static class IdentityServiceCollectionExtensions
{
    ...
    public static IdentityBuilder AddWebshopAuthentication(this IServiceCollection services, Action<WebshopIdentityOptions> configure)
    {
        ...
        var builder = services
            ...
            .AddEntityFrameworkStores<WebshopAccountsDbContext>()
